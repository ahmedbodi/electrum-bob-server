...
mode, `electrum-bob-server peers` will always return an empty list.
...
`irc_nick` is a nick name that will be appended to the EB_ suffix when
composing the IRC nickname to identify your server on #electrum-bob.
